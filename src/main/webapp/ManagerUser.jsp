							...
							<tbody>
								<c:forEach items="${listMa}" var="o">
									<tr>
										...
										<td>${o.uPass}</td>
										<td>${o.uTK}</td>
										<td><a href="LoadUser?uid=${o.uID}"><button
													type="button" class="btn btn-warning">
													<i class="fa-solid fa-pen-to-square"></i>
												</button></a> <a href="DeleteUser?uname=${o.uName }"><button type="button"
...
<div class="row">
	<div class="col-lg-12">
		<div class="product__pagination Paging_Blog"
			style="padding-bottom: 25px;">
			<c:forEach begin="1" end="2" var="i">
				<a class="${tag==i?"
					active":"" }"
			href="PagingUser?index=${i}"> ${i} </a>
			</c:forEach>
		</div>
	</div>
</div>

...
<body>
	...
	<main>
		<div class="container pt-4">
								...
								<tbody>
									<c:forEach items="${listTop}" var="o">
										<tr>
											<td>${o.BId}</td>
											<td>${o.BName}</td>
											<td><img style="width: 119px; height: 133px;"
												src="${o.BImage}"></td>
											<td>${o.BPriceSale}$</td>
											<td>${o.BPrice }</td>
										</tr>
			...
			<button class=""
				style="font-size: 14px; float: right; color: #ffffff; background: red; font-weight: 700; border: none; text-transform: uppercase; display: inline-block; padding: 10px 20px; border-radius: 5px;"
				type="submit">
				<a href="Top10Excel" class="text-white">XUẤT FILE EXCEL</a>
		</div>
